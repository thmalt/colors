...
func OklchToRec2020OETF(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
...
//	-> Linear Rec. 2020
//	-> Linear Rec. 2100
func OklchToLinearRec2100(l, c, h float64) (r, g, b float64) {
	return OklchToLinearRec2020(l, c, h)
}
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 PQ
func OklchToRec2100PQ(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 HLG
func OklchToRec2100HLG(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
