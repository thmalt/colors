...
//	-> Linear sRGB
//	-> sRGB
func LabD50ToSrgb(l, a, b float64) (float64, float64, float64) {
...
//	-> CIE XYZ D65
//	-> Linear sRGB
func LabD50ToLinearSrgb(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Linear Display P3
//	-> Display P3
func LabD50ToDisplayP3(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Display P3
func LabD50ToLinearDisplayP3(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Adobe RGB (1998)
func LabD50ToA98(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Adobe RGB (1998)
func LabD50ToLinearA98(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Linear ProPhoto
//	-> ProPhoto
func LabD50ToProPhoto(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D50
//	-> Linear ProPhoto
func LabD50ToLinearProPhoto(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Linear Rec. 2020
//	-> Rec. 2020
func LabD50ToRec2020(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Rec. 2020
func LabD50ToLinearRec2020(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Linear Rec. 2020
//	-> Linear Rec. 2100
func LabD50ToLinearRec2100(l, a, b float64) (float64, float64, float64) {
	return LabD50ToLinearRec2020(l, a, b)
}
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 PQ
func LabD50ToRec2100PQ(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 HLG
func LabD50ToRec2100HLG(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D50
//	-> CIE XYZ D65
func LabD50ToXyzD65(l, a, b float64) (x, y, z float64) {
	x, y, z = LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> Absolute XYZ D65
func LabD50ToXyzAbsD65(l, a, b float64) (x, y, z float64) {
	x, y, z = LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D50
//	-> CIE xyY
func LabD50ToXyYD50(l, a, b float64) (x, y, luminance float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> CIE xyY
func LabD50ToXyYD65(l, a, b float64) (x, y, luminance float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	CIE Lab D50
//	-> CIE LCh D50
func LabD50ToLchD50(l, a, b float64) (float64, float64, float64) {
...
//	-> CIE XYZ D65
//	-> CIE Lab D65
func LabD50ToLabD65(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE Lab D65
//	-> CIE LCh D65
func LabD50ToLchD65(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D50
//	-> CIE Luv D50
func LabD50ToLuvD50(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE Luv D50
//	-> CIE LChuv D50
func LabD50ToLchuvD50(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> CIE Luv D65
func LabD50ToLuvD65(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE Luv D65
//	-> CIE LChuv D65
func LabD50ToLchuvD65(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> Oklab
func LabD50ToOklab(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Oklab
//	-> Oklch
func LabD50ToOklch(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> sRGB
//	-> HSL
func LabD50ToHsl(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> sRGB
//	-> HSV
func LabD50ToHsv(l, a, b float64) (h, s, v float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> sRGB
//	-> HWB
func LabD50ToHwb(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD50ToXyzD50(l, a, b)
