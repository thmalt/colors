...
//	-> CIE XYZ D65
//	-> CIE xyY
func HsvToXyY(h, s, v float64) (x, y, luminance float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbToLinearSrgb(r, g, b)
...
//	-> CIE XYZ D50
//	-> CIE Luv
func HsvToLuv(h, s, v float64) (float64, float64, float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbToLinearSrgb(r, g, b)
...
//	-> CIE Luv
//	-> CIE LChuv
func HsvToLchuv(h, s, v float64) (float64, float64, float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbToLinearSrgb(r, g, b)
