...
func HsvToRec2020OETF(h, s, v float64) (r, g, b float64) {
	r, g, b = HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> Linear Rec. 2020
//	-> Linear Rec. 2100
func HsvToLinearRec2100(h, s, v float64) (r, g, b float64) {
	return HsvToLinearRec2020(h, s, v)
}
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 PQ
func HsvToRec2100PQ(h, s, v float64) (r, g, b float64) {
	r, g, b = HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 HLG
func HsvToRec2100HLG(h, s, v float64) (r, g, b float64) {
	r, g, b = HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> CIE XYZ D50
//	-> CIE xyY
func HsvToXyYD50(h, s, v float64) (x, y, luminance float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> CIE XYZ D65
//	-> CIE xyY
func HsvToXyYD65(h, s, v float64) (x, y, luminance float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> CIE XYZ D50
//	-> CIE Lab D50
func HsvToLabD50(h, s, v float64) (l, a, b float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> CIE Lab D50
//	-> CIE LCh D50
func HsvToLchD50(h, s, v float64) (float64, float64, float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> CIE XYZ D65
//	-> CIE Lab D65
func HsvToLabD65(h, s, v float64) (l, a, b float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> CIE Lab D65
//	-> CIE LCh D65
func HsvToLchD65(h, s, v float64) (float64, float64, float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> CIE XYZ D50
//	-> CIE Luv D50
func HsvToLuvD50(h, s, v float64) (float64, float64, float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> CIE Luv D50
//	-> CIE LChuv D50
func HsvToLchuvD50(h, s, v float64) (float64, float64, float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> CIE XYZ D65
//	-> CIE Luv D65
func HsvToLuvD65(h, s, v float64) (float64, float64, float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
...
//	-> CIE Luv D65
//	-> CIE LChuv D65
func HsvToLchuvD65(h, s, v float64) (float64, float64, float64) {
	r, g, b := HsvToSrgb(h, s, v)
	r, g, b = SrgbDecode(r), SrgbDecode(g), SrgbDecode(b)
