...
//	-> Linear sRGB
//	-> sRGB
func LchD65ToSrgb(l, c, h float64) (r, g, b float64) {
...
//	-> CIE XYZ D65
//	-> Linear sRGB
func LchD65ToLinearSrgb(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Linear Display P3
//	-> Display P3
func LchD65ToDisplayP3(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Display P3
func LchD65ToLinearDisplayP3(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Adobe RGB (1998)
func LchD65ToA98(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Adobe RGB (1998)
func LchD65ToLinearA98(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Linear ProPhoto
//	-> ProPhoto
func LchD65ToProPhoto(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D50
//	-> Linear ProPhoto
func LchD65ToLinearProPhoto(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Linear Rec. 2020
//	-> Rec. 2020
func LchD65ToRec2020(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
func LchD65ToRec2020OETF(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Rec. 2020
func LchD65ToLinearRec2020(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Linear Rec. 2020
//	-> Linear Rec. 2100
func LchD65ToLinearRec2100(l, c, h float64) (r, g, b float64) {
	return LchD65ToLinearRec2020(l, c, h)
}
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 PQ
func LchD65ToRec2100PQ(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 HLG
func LchD65ToRec2100HLG(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> CIE XYZ D50
func LchD65ToXyzD50(l, c, h float64) (x, y, z float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z = LabD65ToXyzD65(l, a, b)
...
//	-> CIE Lab D65
//	-> CIE XYZ D65
func LchD65ToXyzD65(l, c, h float64) (x, y, z float64) {
	l, a, b := LchToLxy(l, c, h)
...
//	-> CIE XYZ D50
//	-> CIE xyY
func LchD65ToXyYD50(l, c, h float64) (x, y, luminance float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> CIE xyY
func LchD65ToXyYD65(l, c, h float64) (x, y, luminance float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D50
//	-> CIE Lab D50
func LchD65ToLabD50(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE Lab D50
//	-> CIE LCh D50
func LchD65ToLchD50(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	CIE LCh D65
//	-> CIE Lab D65
func LchD65ToLabD65(l, c, h float64) (float64, float64, float64) {
...
//	-> CIE XYZ D50
//	-> CIE Luv D50
func LchD65ToLuvD50(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE Luv D50
//	-> CIE LChuv D50
func LchD65ToLchuvD50(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> CIE Luv D65
func LchD65ToLuvD65(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE Luv D65
//	-> CIE LChuv D65
func LchD65ToLchuvD65(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> Oklab
func LchD65ToOklab(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Oklab
//	-> Oklch
func LchD65ToOklch(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> sRGB
//	-> HSL
func LchD65ToHsl(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> sRGB
//	-> HSV
func LchD65ToHsv(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> sRGB
//	-> HWB
func LchD65ToHwb(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD65ToXyzD65(l, a, b)
