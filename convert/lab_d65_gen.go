...
//	-> Linear sRGB
//	-> sRGB
func LabD65ToSrgb(l, a, b float64) (float64, float64, float64) {
...
//	-> CIE XYZ D65
//	-> Linear sRGB
func LabD65ToLinearSrgb(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Linear Display P3
//	-> Display P3
func LabD65ToDisplayP3(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Display P3
func LabD65ToLinearDisplayP3(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Adobe RGB (1998)
func LabD65ToA98(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Adobe RGB (1998)
func LabD65ToLinearA98(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Linear ProPhoto
//	-> ProPhoto
func LabD65ToProPhoto(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D50
//	-> Linear ProPhoto
func LabD65ToLinearProPhoto(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Linear Rec. 2020
//	-> Rec. 2020
func LabD65ToRec2020(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
func LabD65ToRec2020OETF(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Rec. 2020
func LabD65ToLinearRec2020(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Linear Rec. 2020
//	-> Linear Rec. 2100
func LabD65ToLinearRec2100(l, a, b float64) (float64, float64, float64) {
	return LabD65ToLinearRec2020(l, a, b)
}
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 PQ
func LabD65ToRec2100PQ(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 HLG
func LabD65ToRec2100HLG(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> CIE XYZ D50
func LabD65ToXyzD50(l, a, b float64) (x, y, z float64) {
	x, y, z = LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> Absolute XYZ D65
func LabD65ToXyzAbsD65(l, a, b float64) (x, y, z float64) {
	x, y, z = LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D50
//	-> CIE xyY
func LabD65ToXyYD50(l, a, b float64) (x, y, luminance float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> CIE xyY
func LabD65ToXyYD65(l, a, b float64) (x, y, luminance float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D50
//	-> CIE Lab D50
func LabD65ToLabD50(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE Lab D50
//	-> CIE LCh D50
func LabD65ToLchD50(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	CIE Lab D65
//	-> CIE LCh D65
func LabD65ToLchD65(l, a, b float64) (float64, float64, float64) {
	return LxyToLch(l, a, b)
}
...
//	-> CIE XYZ D50
//	-> CIE Luv D50
func LabD65ToLuvD50(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE Luv D50
//	-> CIE LChuv D50
func LabD65ToLchuvD50(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> CIE Luv D65
func LabD65ToLuvD65(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE Luv D65
//	-> CIE LChuv D65
func LabD65ToLchuvD65(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> CIE XYZ D65
//	-> Oklab
func LabD65ToOklab(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> Oklab
//	-> Oklch
func LabD65ToOklch(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> sRGB
//	-> HSL
func LabD65ToHsl(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> sRGB
//	-> HSV
func LabD65ToHsv(l, a, b float64) (h, s, v float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
...
//	-> sRGB
//	-> HWB
func LabD65ToHwb(l, a, b float64) (float64, float64, float64) {
	x, y, z := LabD65ToXyzD65(l, a, b)
