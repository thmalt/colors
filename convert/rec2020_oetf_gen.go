...
func Rec2020OETFToSrgb(r, g, b float64) (float64, float64, float64) {
	r, g, b = Rec2020OETFDecode(r), Rec2020OETFDecode(g), Rec2020OETFDecode(b)
...
func Rec2020OETFToLinearRec2020(r, g, b float64) (float64, float64, float64) {
	return Rec2020OETFDecode(r), Rec2020OETFDecode(g), Rec2020OETFDecode(b)
}
...
//	-> Linear Rec. 2020
//	-> Linear Rec. 2100
func Rec2020OETFToLinearRec2100(r, g, b float64) (float64, float64, float64) {
	return Rec2020OETFDecode(r), Rec2020OETFDecode(g), Rec2020OETFDecode(b)
}
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 PQ
func Rec2020OETFToRec2100PQ(r, g, b float64) (float64, float64, float64) {
	r, g, b = Rec2020OETFDecode(r), Rec2020OETFDecode(g), Rec2020OETFDecode(b)
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 HLG
func Rec2020OETFToRec2100HLG(r, g, b float64) (float64, float64, float64) {
	r, g, b = Rec2020OETFDecode(r), Rec2020OETFDecode(g), Rec2020OETFDecode(b)
...
//	-> CIE XYZ D65
//	-> Absolute XYZ D65
func Rec2020OETFToXyzAbsD65(r, g, b float64) (x, y, z float64) {
	r, g, b = Rec2020OETFDecode(r), Rec2020OETFDecode(g), Rec2020OETFDecode(b)
