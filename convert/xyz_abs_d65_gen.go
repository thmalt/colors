...
// Calls [XyzAbsD65ToLinearRec2020]
//
// Conversion path (3 steps):
//
//	Absolute XYZ D65
...
//	-> Linear Rec. 2020
//	-> Linear Rec. 2100
func XyzAbsD65ToLinearRec2100(x, y, z float64) (r, g, b float64) {
	return XyzAbsD65ToLinearRec2020(x, y, z)
}
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 PQ
func XyzAbsD65ToRec2100PQ(x, y, z float64) (r, g, b float64) {
	x, y, z = XyzAbsD65ToXyzD65(x, y, z)
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 HLG
func XyzAbsD65ToRec2100HLG(x, y, z float64) (r, g, b float64) {
	x, y, z = XyzAbsD65ToXyzD65(x, y, z)
