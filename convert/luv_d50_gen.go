...
//	-> Linear Rec. 2020
//	-> Linear Rec. 2100
func LuvD50ToLinearRec2100(l, u, v float64) (r, g, b float64) {
	return LuvD50ToLinearRec2020(l, u, v)
}
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 PQ
func LuvD50ToRec2100PQ(l, u, v float64) (r, g, b float64) {
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 HLG
func LuvD50ToRec2100HLG(l, u, v float64) (r, g, b float64) {
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE XYZ D65
//	-> Absolute XYZ D65
func LuvD50ToXyzAbsD65(l, u, v float64) (x, y, z float64) {
	x, y, z = LuvD50ToXyzD50(l, u, v)
