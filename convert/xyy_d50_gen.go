...
//	-> Linear sRGB
//	-> sRGB
func XyYD50ToSrgb(x, y, luminance float64) (r, g, b float64) {
...
//	-> CIE XYZ D65
//	-> Linear sRGB
func XyYD50ToLinearSrgb(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> Linear Display P3
//	-> Display P3
func XyYD50ToDisplayP3(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE XYZ D65
//	-> Linear Display P3
func XyYD50ToLinearDisplayP3(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> Adobe RGB (1998)
func XyYD50ToA98(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE XYZ D65
//	-> Linear Adobe RGB (1998)
func XyYD50ToLinearA98(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> Linear ProPhoto
//	-> ProPhoto
func XyYD50ToProPhoto(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE XYZ D50
//	-> Linear ProPhoto
func XyYD50ToLinearProPhoto(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> Linear Rec. 2020
//	-> Rec. 2020
func XyYD50ToRec2020(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
func XyYD50ToRec2020OETF(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE XYZ D65
//	-> Linear Rec. 2020
func XyYD50ToLinearRec2020(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> Linear Rec. 2020
//	-> Linear Rec. 2100
func XyYD50ToLinearRec2100(x, y, luminance float64) (r, g, b float64) {
	return XyYD50ToLinearRec2020(x, y, luminance)
}
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 PQ
func XyYD50ToRec2100PQ(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 HLG
func XyYD50ToRec2100HLG(x, y, luminance float64) (r, g, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	CIE xyY
//	-> CIE XYZ D50
func XyYD50ToXyzD50(x, y, luminance float64) (float64, float64, float64) {
...
//	-> CIE XYZ D50
//	-> CIE XYZ D65
func XyYD50ToXyzD65(x, y, luminance float64) (float64, float64, float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE XYZ D50
//	-> CIE Lab D50
func XyYD50ToLabD50(x, y, luminance float64) (l, a, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE Lab D50
//	-> CIE LCh D50
func XyYD50ToLchD50(x, y, luminance float64) (l, c, h float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE XYZ D65
//	-> CIE Lab D65
func XyYD50ToLabD65(x, y, luminance float64) (l, a, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE Lab D65
//	-> CIE LCh D65
func XyYD50ToLchD65(x, y, luminance float64) (l, c, h float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE XYZ D50
//	-> CIE Luv D50
func XyYD50ToLuvD50(x, y, luminance float64) (l, u, v float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE Luv D50
//	-> CIE LChuv D50
func XyYD50ToLchuvD50(x, y, luminance float64) (l, c, h float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE XYZ D65
//	-> CIE Luv D65
func XyYD50ToLuvD65(x, y, luminance float64) (l, u, v float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE Luv D65
//	-> CIE LChuv D65
func XyYD50ToLchuvD65(x, y, luminance float64) (l, c, h float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> CIE XYZ D65
//	-> Oklab
func XyYD50ToOklab(x, y, luminance float64) (l, a, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> Oklab
//	-> Oklch
func XyYD50ToOklch(x, y, luminance float64) (l, c, h float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> sRGB
//	-> HSL
func XyYD50ToHsl(x, y, luminance float64) (h, s, l float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> sRGB
//	-> HSV
func XyYD50ToHsv(x, y, luminance float64) (h, s, v float64) {
	x, y, z := XyYToXyz(x, y, luminance)
...
//	-> sRGB
//	-> HWB
func XyYD50ToHwb(x, y, luminance float64) (h, w, b float64) {
	x, y, z := XyYToXyz(x, y, luminance)
