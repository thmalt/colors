...
//	-> Linear sRGB
//	-> sRGB
func LchuvD50ToSrgb(l, c, h float64) (r, g, b float64) {
...
//	-> CIE XYZ D65
//	-> Linear sRGB
func LchuvD50ToLinearSrgb(l, c, h float64) (r, g, b float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> Linear Display P3
//	-> Display P3
func LchuvD50ToDisplayP3(l, c, h float64) (r, g, b float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE XYZ D65
//	-> Linear Display P3
func LchuvD50ToLinearDisplayP3(l, c, h float64) (r, g, b float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> Adobe RGB (1998)
func LchuvD50ToA98(l, c, h float64) (r, g, b float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE XYZ D65
//	-> Linear Adobe RGB (1998)
func LchuvD50ToLinearA98(l, c, h float64) (r, g, b float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> Linear ProPhoto
//	-> ProPhoto
func LchuvD50ToProPhoto(l, c, h float64) (r, g, b float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE XYZ D50
//	-> Linear ProPhoto
func LchuvD50ToLinearProPhoto(l, c, h float64) (r, g, b float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> Linear Rec. 2020
//	-> Rec. 2020
func LchuvD50ToRec2020(l, c, h float64) (r, g, b float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE XYZ D65
//	-> Linear Rec. 2020
func LchuvD50ToLinearRec2020(l, c, h float64) (r, g, b float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> Linear Rec. 2020
//	-> Linear Rec. 2100
func LchuvD50ToLinearRec2100(l, c, h float64) (r, g, b float64) {
	return LchuvD50ToLinearRec2020(l, c, h)
}
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 PQ
func LchuvD50ToRec2100PQ(l, c, h float64) (r, g, b float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 HLG
func LchuvD50ToRec2100HLG(l, c, h float64) (r, g, b float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE Luv D50
//	-> CIE XYZ D50
func LchuvD50ToXyzD50(l, c, h float64) (x, y, z float64) {
	l, u, v := LchToLxy(l, c, h)
	return LuvD50ToXyzD50(l, u, v)
}
...
//	-> CIE XYZ D50
//	-> CIE XYZ D65
func LchuvD50ToXyzD65(l, c, h float64) (x, y, z float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z = LuvD50ToXyzD50(l, u, v)
...
//	-> CIE XYZ D50
//	-> CIE xyY
func LchuvD50ToXyYD50(l, c, h float64) (x, y, luminance float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE XYZ D65
//	-> CIE xyY
func LchuvD50ToXyYD65(l, c, h float64) (x, y, luminance float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE XYZ D50
//	-> CIE Lab D50
func LchuvD50ToLabD50(l, c, h float64) (float64, float64, float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE Lab D50
//	-> CIE LCh D50
func LchuvD50ToLchD50(l, c, h float64) (float64, float64, float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE XYZ D65
//	-> CIE Lab D65
func LchuvD50ToLabD65(l, c, h float64) (float64, float64, float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE Lab D65
//	-> CIE LCh D65
func LchuvD50ToLchD65(l, c, h float64) (float64, float64, float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	CIE LChuv D50
//	-> CIE Luv D50
func LchuvD50ToLuvD50(l, c, h float64) (float64, float64, float64) {
...
//	-> CIE XYZ D65
//	-> CIE Luv D65
func LchuvD50ToLuvD65(l, c, h float64) (float64, float64, float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE Luv D65
//	-> CIE LChuv D65
func LchuvD50ToLchuvD65(l, c, h float64) (float64, float64, float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> CIE XYZ D65
//	-> Oklab
func LchuvD50ToOklab(l, c, h float64) (float64, float64, float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> Oklab
//	-> Oklch
func LchuvD50ToOklch(l, c, h float64) (float64, float64, float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> sRGB
//	-> HSL
func LchuvD50ToHsl(l, c, h float64) (float64, float64, float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> sRGB
//	-> HSV
func LchuvD50ToHsv(l, c, h float64) (float64, float64, float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
...
//	-> sRGB
//	-> HWB
func LchuvD50ToHwb(l, c, h float64) (float64, float64, float64) {
	l, u, v := LchToLxy(l, c, h)
	x, y, z := LuvD50ToXyzD50(l, u, v)
