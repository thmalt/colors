...
//	-> Linear sRGB
//	-> sRGB
func LchD50ToSrgb(l, c, h float64) (r, g, b float64) {
...
//	-> CIE XYZ D65
//	-> Linear sRGB
func LchD50ToLinearSrgb(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Linear Display P3
//	-> Display P3
func LchD50ToDisplayP3(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Display P3
func LchD50ToLinearDisplayP3(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Adobe RGB (1998)
func LchD50ToA98(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Adobe RGB (1998)
func LchD50ToLinearA98(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Linear ProPhoto
//	-> ProPhoto
func LchD50ToProPhoto(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D50
//	-> Linear ProPhoto
func LchD50ToLinearProPhoto(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Linear Rec. 2020
//	-> Rec. 2020
func LchD50ToRec2020(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
func LchD50ToRec2020OETF(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> Linear Rec. 2020
func LchD50ToLinearRec2020(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Linear Rec. 2020
//	-> Linear Rec. 2100
func LchD50ToLinearRec2100(l, c, h float64) (r, g, b float64) {
	return LchD50ToLinearRec2020(l, c, h)
}
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 PQ
func LchD50ToRec2100PQ(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Linear Rec. 2100
//	-> Rec. 2100 HLG
func LchD50ToRec2100HLG(l, c, h float64) (r, g, b float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE Lab D50
//	-> CIE XYZ D50
func LchD50ToXyzD50(l, c, h float64) (x, y, z float64) {
	l, a, b := LchToLxy(l, c, h)
	return LabD50ToXyzD50(l, a, b)
}
...
//	-> CIE XYZ D50
//	-> CIE XYZ D65
func LchD50ToXyzD65(l, c, h float64) (x, y, z float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z = LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> Absolute XYZ D65
func LchD50ToXyzAbsD65(l, c, h float64) (x, y, z float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z = LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D50
//	-> CIE xyY
func LchD50ToXyYD50(l, c, h float64) (x, y, luminance float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> CIE xyY
func LchD50ToXyYD65(l, c, h float64) (x, y, luminance float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	CIE LCh D50
//	-> CIE Lab D50
func LchD50ToLabD50(l, c, h float64) (float64, float64, float64) {
...
//	-> CIE XYZ D65
//	-> CIE Lab D65
func LchD50ToLabD65(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE Lab D65
//	-> CIE LCh D65
func LchD50ToLchD65(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D50
//	-> CIE Luv D50
func LchD50ToLuvD50(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE Luv D50
//	-> CIE LChuv D50
func LchD50ToLchuvD50(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> CIE Luv D65
func LchD50ToLuvD65(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE Luv D65
//	-> CIE LChuv D65
func LchD50ToLchuvD65(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> CIE XYZ D65
//	-> Oklab
func LchD50ToOklab(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> Oklab
//	-> Oklch
func LchD50ToOklch(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> sRGB
//	-> HSL
func LchD50ToHsl(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> sRGB
//	-> HSV
func LchD50ToHsv(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
...
//	-> sRGB
//	-> HWB
func LchD50ToHwb(l, c, h float64) (float64, float64, float64) {
	l, a, b := LchToLxy(l, c, h)
	x, y, z := LabD50ToXyzD50(l, a, b)
