...
func (w *GoWriter) SaveGoFile(filename, pkg, tags string, forceWrite bool) bool {
	data, err := w.buildGo(pkg, tags)
	if err != nil {
...
func (w *GoWriter) buildGo(pkg, tags string) ([]byte, error) {
	...
	return formatCode(pkg, tags, header, buf.Bytes(), w.formatSource)
}
